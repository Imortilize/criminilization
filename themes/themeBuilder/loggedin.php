...
<!DOCTYPE html>
    <html>
        <head>
			...
			<link href="themes/{_theme}/css/game_layout_elements.css" rel="stylesheet" />
            {#if moduleCSSFile}
            ...
            <div class="{_themeSettings.layoutContainer}">
							...
							<div class="col-md-8">
								...
								<div class="panel panel-default">
									<div class="panel-heading text-left">
										<i class="fa-solid fa-users"></i> {usersOnline} Users Online <small class="pull-right">In the last 30 minutes</small> 
									</div>
									<div class="panel-body text-center">

										{#each onlineGroups}
											[ {#each users}
													&nbsp;<a href="?page=profile&view={user.id}" {#if isAdmin}style="color: {user.color}"{/if}
													  class="
														user-online 
														{#if isBuddy}is-buddy{/if} 
														{#if isCrew}is-crew{/if} 
														{#if isUser}is-user{/if} 
														{#if isCrewOwner}is-crew-boss{/if}
													">{user.name}</a> {#unless last}|{/unless}         
												{/each} ] 
										{/each}
									</div>
								</div>
                ...
                <nav class="navbar navbar-default navbar-fixed-bottom">
                    ...
                    <div class="container hidden-xs">
                        ...
                        <p class="navbar-text navbar-right"><a href="https://glscript.net" target="_blank" class="text-muted">Criminilization v0.0.1</a></small></p>
                    </div>
                </nav>
            </div>
            ...
            public $userInfo = '
                <div class="panel panel-default">
                    ...
                    <div class="panel-body character-information">
                        <div class="media">
							...
							<!--<div class="media-body">
								<div class="radial-progress">-->
									<!-- Creating a radial-progress-widgets classes that store other useful classes like radial-progress-values and radial-progress-labels -->
									<!--<div class="radial-progress-widgets">
									</div>
								</div>
							</div>-->
                        </div>
                        ...
                        <p>
                            <strong>Location:</strong> <small class="pull-right">{location} 
							(<span data-timer-type="inline" data-timer="{travel_timers}"></span>)
							</small>
                        </p>
                        <p>
                        ...
                        <div class="progress">
                            <div class="progress-bar progress-bar-info progress-bar-striped" style="width: {exp_perc}%"></div>
                        </div>
						
						<!-- Stats Bar -->
						<strong>Stats:</strong>
                        <div class="progress">
                             <div class="progress-bar progress-bar-danger progress-bar-striped" style="width: {off_perc}%"></div>
							<div class="progress-bar progress-bar-info progress-bar-striped" style="width: {def_perc}%"></div>
							<div class="progress-bar progress-bar-success progress-bar-striped" style="width: {stl_perc}%"></div>
                        </div>
