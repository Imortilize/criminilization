            ...
            <table class="table table-striped table-bordered table-condensed">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" width="35px">Name</th>
                        <th class="text-center" width="35px">Time to Travel (seconds)</th>
                        <th class="text-center" width="35px">Distance Range (KM)</th>
                        <th class="text-center" width="35px">Fuel Cost</th>
                        <th class="text-center" width="35px">Price</th>
                        <th class="text-center" width="35px">Trade Units</th>
                        <th class="text-center" width="35px">Rank</th>
    ...
    public $vehiclesForm = '
            <form method="post" action="?page=admin&module=vehicles&action={editType}&id={id}">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="pull-left">Vehicle Travel Time (seconds)</label>
