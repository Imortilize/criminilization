        ...
        private function getUser($userID, $search = false) {
            ...
            $sql = ("
                SELECT
					...
					US_offence as 'offence', 
					US_defence as 'defence', 
					US_stealth as 'stealth', 
                    R_name as 'round',
                    US_bio as 'bio', 
                    US_pic as 'pic'
                FROM users
            ...
            if (isset($this->methodData->submit)) {
                ...
                if (count($errors)) {
                    ...
                    ", array(
						...
						":offence" => $this->methodData->offence,
						":defence" => $this->methodData->defence,
						":stealth" => $this->methodData->stealth,
                        ":id" => $this->methodData->id
                    ));
