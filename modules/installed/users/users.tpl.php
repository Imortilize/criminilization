				...
				<div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="offence" value="{offence}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">Defence</label>
                            <input type="text" class="form-control" name="defence" value="{defence}">
                        </div>
                    </div>
					<div class="col-md-4">
                        <div class="form-group">
                            <label class="pull-left">Stealth</label>
                            <input type="text" class="form-control" name="stealth" value="{stealth}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
