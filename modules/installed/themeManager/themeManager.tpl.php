        ...
        public $themeOptions = '
            ...
            <form method="post" action="?page=admin&module=themeManager&action=options">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="pull-left">User protection (days)</label>
                            <input class="form-control" type="number" name="userProtection" value="{userProtection}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="pull-left">Delete logs (days)</label>
                            <input class="form-control" type="number" name="deleteLogs" value="{deleteLogs}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
