    ...
    class adminModule {
        ...
        public function method_options() {
            ...
            if (isset($this->methodData->submit)) {
                ...
                $settings->update("userProtection", $this->methodData->userProtection);
                $settings->update("deleteLogs", $this->methodData->deleteLogs);
                $this->html .= $this->page->buildElement("success", array(
            ...
            $output = array(
                ...
                "userProtection" => $settings->loadSetting("userProtection"),
                "deleteLogs" => $settings->loadSetting("deleteLogs"),
            );
