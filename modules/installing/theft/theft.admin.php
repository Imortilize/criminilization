        ...
        private function getTheft($theftID = "all") {
            ...
            $theft = $this->db->prepare("
                SELECT
                    ...
                    T_minDamage as 'minDamage',  
                    T_maxDamage as 'maxDamage',  
                    T_cooldown as 'cooldown',  
            ...
            if (isset($this->methodData->submit)) {
                ...
                if (count($errors)) {
                    ...
                    $insert = $this->db->prepare("
                        INSERT INTO theft (T_name, T_chance, T_worstCar, T_maxDamage, T_minDamage, T_bestCar, T_cooldown)  VALUES (:name, :chance, :worstCar, :maxDamage, :minDamage, :bestCar, :cooldown);
                    ");
                    ...
                    $insert->bindParam(":minDamage", $this->methodData->minDamage);
            ...
            if (isset($this->methodData->submit)) {
                ...
                if (count($errors)) {
                    ...
                    $update = $this->db->prepare("
                        UPDATE theft SET T_name = :name, T_chance = :chance, T_worstCar = :worstCar, T_maxDamage = :maxDamage, T_minDamage = :minDamage, T_bestCar = :bestCar , T_cooldown = :cooldown WHERE T_id = :id
                    ");
                    ...
                    $update->bindParam(":minDamage", $this->methodData->minDamage);
