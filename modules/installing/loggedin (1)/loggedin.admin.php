            ...
            if (isset($this->methodData->submit)) {
                ...
                if (count($errors)) {
                    ...
                    $insert = $this->db->prepare("
                        INSERT INTO gameNews (GN_author, GN_title, GN_text, GN_type, GN_date)  VALUES (:gnauthor, :gntitle, :gntext, :type, UNIX_TIMESTAMP());
                    ");
            ...
            if (isset($this->methodData->submit)) {
                ...
                if (count($errors)) {
                    ...
                    $update = $this->db->prepare("
                        UPDATE gameNews SET GN_title = :gntitle, GN_text = :gntext, GN_type = :type WHERE GN_id = :id
                    ");
